...
df=puskesmas
puskesmasMatrix=as.matrix(cbind(df$puskes, df$dokterumum, df$doktergigi, df$perawat, df$bidan, df$Rasio_dokter_umum, df$Rasio_dokter_gigi, df$Rasio_perawat, df$Rasio_bidan),ncol=9)
